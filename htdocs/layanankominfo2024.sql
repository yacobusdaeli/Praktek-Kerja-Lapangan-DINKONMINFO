...
--
-- Host: localhost:3306
-- Generation Time: Feb 07, 2025 at 08:39 AM
...
(8, 'admin1', 'admin1', 'e00cf25ad42683b3df678c61f42c6bda');
...
CREATE TABLE `aduan_infrastruktur_jaringan_inter` (
  `id_aduan_jar_inter` int NOT NULL,
...
CREATE TABLE `fasilitas_inter_wifi` (
  `id_fas_inter_wifi` int NOT NULL,
  `waktu` datetime NOT NULL,
  `nama` varchar(256) NOT NULL,
  `jabatan` varchar(256) NOT NULL,
...
CREATE TABLE `fasilitas_video_conference` (
  `id_fas_video_conference` int NOT NULL,
  `waktu` datetime NOT NULL,
  `nama` varchar(256) NOT NULL,
  `jabatan` varchar(256) NOT NULL,
  `nip` varchar(256) NOT NULL,
...
CREATE TABLE `hak_akses_matur_bupati` (
  `id_hak_akses_maturbup` int NOT NULL,
  `waktu` datetime NOT NULL,
  `nama` varchar(256) NOT NULL,
  `jabatan` varchar(256) NOT NULL,
  `no_telp` varchar(13) NOT NULL,
...
CREATE TABLE `pengajuan_magang` (
  `id_pengajuan_magang` int NOT NULL,
  `waktu` datetime NOT NULL,
  `nama` varchar(125) NOT NULL,
  `no_induk` varchar(100) NOT NULL,
  `no_telp` varchar(55) NOT NULL,
  `pendidikan` varchar(100) NOT NULL,
  `institusi` varchar(155) NOT NULL,
  `jurusan` varchar(155) NOT NULL,
  `surat_permohonan` varchar(55) NOT NULL,
...
INSERT INTO `pengajuan_magang` (`id_pengajuan_magang`, `waktu`, `nama`, `no_induk`, `no_telp`, `pendidikan`, `institusi`, `jurusan`, `surat_permohonan`, `status`) VALUES
(15, '2024-12-29 02:27:08', 'Tes', 'H1C022031', '08788515223', 'S1', 'Institusi Perguruan Meng (IPM)', 'Informatika', 'surat_permohonan_Tes.pdf', 'Diterima'),
(16, '2024-12-30 01:13:38', 'Eren Yeager', 'IA022057', '08788515223', 'SMK', 'SMA 1 BUKATEJA', 'IPA', 'surat_permohonan_Eren_Yeager.pdf', 'Ditolak'),
(17, '2024-12-30 09:26:10', 'Algufron', 'H1D022019', '087755911132', 'SMK', 'Universitas Indonesia', 'Manajemen Bisnis', 'surat_permohonan_Algufron.pdf', 'Proses'),
(18, '2024-04-17 09:27:52', 'Ken Takakura', 'H1C022018', '085717173823', 'S1', 'Institut Teknologi Bandung', 'Elektronika dan Informatika', 'surat_permohonan_Ken_Takakura.pdf', 'Ditolak'),
(28, '2025-01-13 14:25:15', 'Yacobus Daeli', 'H1D022024', '087755911328', 'S1', 'Universitas Jenderal Soedirman', 'Informatika', 'surat_permohonan_Yacobus_Daeli.pdf', 'Proses');
...
ALTER TABLE `pengajuan_magang`
  ADD PRIMARY KEY (`id_pengajuan_magang`);
...
--
ALTER TABLE `aduan_infrastruktur_jaringan_inter`
  MODIFY `id_aduan_jar_inter` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `aduan_pengelolaan_website`
--
ALTER TABLE `aduan_pengelolaan_website`
  MODIFY `id_aduan_web` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `fasilitas_inter_wifi`
--
ALTER TABLE `fasilitas_inter_wifi`
  MODIFY `id_fas_inter_wifi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `fasilitas_video_conference`
--
ALTER TABLE `fasilitas_video_conference`
  MODIFY `id_fas_video_conference` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `hak_akses_matur_bupati`
--
ALTER TABLE `hak_akses_matur_bupati`
  MODIFY `id_hak_akses_maturbup` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `hak_akses_website`
--
ALTER TABLE `hak_akses_website`
  MODIFY `id_hak_akses_web` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `pengajuan_magang`
  MODIFY `id_pengajuan_magang` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `website_desa`
--
ALTER TABLE `website_desa`
  MODIFY `id_web_desa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
COMMIT;
