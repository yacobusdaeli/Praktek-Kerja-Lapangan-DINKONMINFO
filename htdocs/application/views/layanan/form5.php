<section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
        ...
        <h3>Permohonan Fasilitas Video Conference</h3>
    </div>
</section>
...
<main id="main">
    ...
    echo '</div>';
            ...
            <form action="<?=base_url('form5/upload')?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        <h3 class="text-uppercase">permohon fasilitas video conference</h3>
