...
<section id="intro" class="intro">
        <div class="container">
            <ul class="text-left">
                <li><a href="#statistik-status">Statistik Berdasarkan Status Permohonan Magang</a></li>
                <li><a href="#statistik-bulanan">Statistik Berdasarkan Waktu</a></li>
                <li><a href="#statistik-institusi">Statistik Berdasarkan Institusi</a></li>
                <li><a href="#statistik-jurusan">Statistik Berdasarkan Jurusan</a></li>
            </ul>
        </div>
    </section>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: ['rgb(255, 159, 64)','rgb(75, 192, 192)','rgb(255, 99, 132)'],
                borderWidth: 1
            }]
        },
        options: {
...
<script>
    ...
    const borderColors = backgroundColors.map(color => color.replace('0.2', '1')); // Ubah transparansi border
